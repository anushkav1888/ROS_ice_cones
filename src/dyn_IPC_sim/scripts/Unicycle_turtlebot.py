...
def main():
    ...
    #turtlebot3_6 = RobotBase('tb3_6')
    turtlebot3_7 = RobotBase('tb3_7')
    #turtlebot3_8 = RobotBase('tb3_8')
    #turtlebot3_2 = RobotBase('/tb3_2')
    ...
    while not rospy.is_shutdown():
        ...
        #turtlebot3_0.controller([-0.027,0.185])
        #turtlebot3_6.controller([-0.75,0])
        #turtlebot3_2.controller([-1.28,0.489])
        #turtlebot3_4.controller([1,0])
        #turtlebot3_1.controller([-0.25,1])
        turtlebot3_7.controller([-1.0,0.5])
        #turtlebot3_3.controller([0.0,0.5])   
        #turtlebot3_2.controller([0.4,0.25])
        #turtlebot3_8.controller([-1.0,0])
        rate.sleep()
