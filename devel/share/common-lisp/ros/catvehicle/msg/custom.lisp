...
(cl:defmethod cl:initialize-instance :after ((m <custom>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'custom)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name catvehicle-msg:<custom> is deprecated: use catvehicle-msg:custom instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader catvehicle-msg:x-val is deprecated.  Use catvehicle-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader catvehicle-msg:y-val is deprecated.  Use catvehicle-msg:y instead.")
  (y m))
